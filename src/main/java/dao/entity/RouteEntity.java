...
public class RouteEntity {
    ...
    public RouteEntity(String fromX, String fromY, String toX, String toY, String token) {
        try {
    ...
    public RouteEntity(double fromX, double fromY, double toX, double toY, String token) {
        this.fromX = fromX;
        this.fromY = fromY;
        this.toX = toX;
        this.toY = toY;
