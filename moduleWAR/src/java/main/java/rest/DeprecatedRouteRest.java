...
@Path("oldroute")
public class DeprecatedRouteRest {

    private static ArrayList<OldRouteEntity> routes = new ArrayList<>();
    ...
    public String createRoute (@QueryParam("fromx")String fromx, @QueryParam("tox")String tox,
        ...
        try {
            routes.add(new OldRouteEntity(Double.parseDouble(fromx), Double.parseDouble(fromy), Double.parseDouble(tox),
